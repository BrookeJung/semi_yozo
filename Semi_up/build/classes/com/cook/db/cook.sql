...
CREATE TABLE LOGIN(
	...
	DOB NUMBER(10) NOT NULL,
	PICK VARCHAR2(2) NOT NULL,
	CONSTRAINT CON_ID UNIQUE(ID)
);

INSERT INTO LOGIN(SEQ, NAME, ID, PW, ADDR, EMAIL, DOB, PICK)
VALUES(LOGINSEQ.NEXTVAL,'정햇나라','ASDF','ASDF','경기도 성남시 중원구','ASDF@ASDF',19921130,'N');
...
INSERT INTO BOARD(BOARDNO,WRITER, TITLE, CONTENT, REGDATE)
