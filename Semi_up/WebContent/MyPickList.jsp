...
<!--==============================Content=================================-->
	...
	<p style="font-size: 40px; "><b>내가 찜 한 레시피</b></p>
	<br/><br/><br/><br/><br/>
	
	<div style=' float:left;width:33%;'>
		<a id="list" href="#"><img alt="" src="images/big1.jpg">
		<div style='display:inline; border: 1px solid ;'>
		</div><br/>
		<p style="font-size: 20px; text-align: center;"><b>글 제목</b></p>
		<p style="text-align: center;">글 내용</p>
		</a> 
	</div>
	
	<div style=' float:left;width:33%;'>
		<a id="list" href="#"><img alt="" src="images/big2.jpg">
		<div style='display:inline; border: 1px solid ;'>
		</div><br/>
		<p style="font-size: 20px; text-align: center;"><b>글 제목</b></p>
		<p style="text-align: center;">글 내용</p>
	...
	<div style=' float:left;width:33%;'>
		<a id="list" href="#"><img alt="" src="images/big3.jpg">
		<div style='display:inline; border: 1px solid ;'>
		</div><br/>
		<p style="font-size: 20px; text-align: center;"><b>글 제목</b></p>
		<p style="text-align: center;">글 내용</p>
