...
<body>
	<form id="formLogin" name="formLogin" method="post" action="로그인컨트롤러로가자">
		<div class="wrapper">
			<div class="header">
				<h1>
					<img src="images/logo.png" width="300" height="100" alt="로그인">
				</h1>
			</div>
			<div id="contents">
				...
				<div class="loginSec" id="loginSec">
					<div class="idPass">
						<fieldset>
							...
							<div class="btLogin">
								<button type="button" class="button01" id="btnLogin" a2s="click"
									obj="P_LOGIN" opt="{&quot;Name&quot;:&quot;IDLogIn&quot;}">
									<span>YoriJori 로그인</span>
								</button>
							</div>
						</fieldset>
					...
					<p class="loginMenu">
						<a href="찾을경로" a2s="click" obj="P_LOGIN"
							opt="{&quot;Name&quot;:&quot;IDSearch&quot;}"
							onclick="NgbMember.SearchNexonID( 1 ); return false;"
							class="schId">YoriJori ID 찾기</a> <span>|</span> <a href="비번찾기"
							a2s="click" obj="P_LOGIN"
							opt="{&quot;Name&quot;:&quot;PWSearch&quot;}"
							onclick="NgbMember.SearchPassword( 1 ); return false;"
							class="schPass">비밀번호 찾기</a> <span>|</span> <a href="회원가입하로가기"
							a2s="click" obj="P_LOGIN"
							opt="{&quot;Name&quot;:&quot;Join&quot;}"
					...
					<div class="tpa">
						...
						<a href="페북" id="btnLogin3" class="btLoginFacebook" a2s="click"
							...
							width="440" height="52" alt="Facebook 로그인"></a> <a
							href="구글(우린카카오)" id="btnLogin4" class="btLoginGoogle" a2s="click"
							obj="P_LOGIN" opt="{&quot;Name&quot;:&quot;TPALogingoogle&quot;}"><img
							src="images/KAKAOLOGIN.png" width="440" height="52"
							alt="kakao 로그인"></a> <a href="네이버" id="btnLogin5"
