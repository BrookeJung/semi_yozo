...
public class RecipeInfoDto {
	...
	public RecipeInfoDto(int recipe_id, String recipe_nm_ko, String sumry, int nation_code, String nation_nm,
			int ty_code, String ty_nm, int cooking_time, String calorie, String qnt, String level_nm, String irdnt_code,
			String img_url, String det_url, int views, String id) {
		super();
