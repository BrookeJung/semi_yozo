...
public class recipe_InfoDto {
	...
	public recipe_InfoDto() {
		super();
	}

	public recipe_InfoDto(int recipe_id, String recipe_nm_ko, String sumry, int nation_code, String nation_nm, int ty_code,
			String ty_nm, String cooking_time, String calorie, String qnt, String level_nm, String irdnt_code,
			String img_url, String det_url) {
		super();
