...
// 레시피재료 DTO
public class recipe_materialDto {
...
//	재료 타입명
	...
	public recipe_materialDto(int recipe_id, int irdnt_sn, String irdnt_nm, String irdnt_cpcty, String irdnt_ty_code,
			String irdnt_ty_nm) {
