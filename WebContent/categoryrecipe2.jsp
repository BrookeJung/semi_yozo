...
<div style="background: white; width: 100% ; max-height: 1800px; overflow: auto; min-height: 300px; height: auto;">
   ...
   <div id="content" style="padding-bottom: 50px;" >
      <c:choose>
         <c:when test="${empty recommendrecipe }">
            <h4 style="font-family: '야놀자 야체','YanoljaYacheR' ; font-size: 15pt; text-align: center;">----조건에만족하는 레시피가 없습니다 .----</h4>
         </c:when>
         <c:otherwise>
            ...
            <c:forEach items="${recommendrecipe }" var="dto">
               <form action="RecipeController.do" method="post" >
                  ...
                  <input type="hidden" name="recommendrecipeid" value="${dto.recipe_id }">   
                           ...
                           <div class="foruser" style="width:30%; height:20%;">${dto.img_url}</div>
                           </c:when>
                           <c:otherwise>
