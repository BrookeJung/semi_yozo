...
<div style="background: white; width: 100% ; text-align: left; padding: 5%; height: 450px;">

   
   <div id="content" style="padding-bottom: 50px;" >
      <h1 class="" style="font-size: 30pt; color: #db5e49; font-family: 야놀자 야체; text-align: left; padding-left: 3%">냉장고 추천레시피!!</h1>
      ...
      <c:forEach items="${recommendrecipe }" var="dto">
         ...
         <input type="hidden" name="recommendrecipeid" value="${dto.recipe_id }">
            <div id="printView"  style="float:left; width: 30%; height:500px; padding-bottom: 2%; padding-left: 3%;">
               ...
               <input type="submit" value="자세히보러가기" class="e2">
               <input class="e2" type="button" value="찜" onclick="location.href='zzimController.do?command=zzimInsert&id=${ldto.id}&recipe_id=${dto.recipe_id}&recipe_nm_ko=${dto.recipe_nm_ko}'">
