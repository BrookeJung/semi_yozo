...
<div style="background: white; width: 100% ;height: 100%; text-align: left; padding: 5%;">
   ...
   <div
      style="border: 3px groove; background-color: #ffe3d5; width: 700px; height: 700px; margin-left: 20%; margin-right: 20%;">
      <br /> <br />
      <p align="center" style="
color: #db5e49; font-family: 야놀자 야체; font-size: 30pt;"
         >회원가입</p>
         ...
         <div style="width: 300px; height: 470px; margin: auto;">
            ...
            <div style="width: 100%; height: 30px;">
               <input type="text" name="name" value=${name } placeholder="이름"
                  required="required" style="width: 99%; height: 30px" readonly="readonly">
            </div>
            <p>
            <div style="width: 100%; height: 30px;">
               <div>
                  <input type="text" name="id" value="${id }" placeholder="ID" title="n"
                     required="required" style="width: 60%; height: 30px; float: left" readonly="readonly">
               ...
               <table border="1">
                  <tr>
                     <td class="btn_bgtd_timeout" align="right"><script
                        ...
                        style="font-family: 야놀자 야체;">인증시간 연장</a> &nbsp;&nbsp;&nbsp;</td>
                  </tr>
               </table>
            </div>
            <p>
