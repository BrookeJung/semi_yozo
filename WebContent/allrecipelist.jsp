...
<body class="page1" style="font-family: '야놀자 야체','YanoljaYacheR' ;">
   ...
   <!--==============================Content=================================-->
<div style="background: white; width: 100% ; height: 100%; text-align: left; overflow: auto;">

   
   <div id="content" style="padding-bottom: 50px; height: auto; overflow: auto;  " >
      <h1 class="" style="font-size: 30pt;
color: #db5e49; font-family: '야놀자 야체','YanoljaYacheR' ; text-align: left; padding-top:3%; padding-left: 3%">모든 레시피</h1>
      ...
      <c:forEach items="${recommendrecipe }" var="dto">
         ...
         <input type="hidden" name="recommendrecipeid" value="${dto.recipe_id }">
            <div id="printView"  style="float:left; width: 30%; height:500px; padding-bottom: 2%; padding-left: 3%;">
               ...
               <input type="button" value="찜" onclick="location.href='zzimController.do?command=zzimInsert&id=${ldto.id}&recipe_id=${dto.recipe_id}&recipe_nm_ko=${dto.recipe_nm_ko}'">
      ...
      <div class="paging" style="position:absolute; width: 99%; height: 30px; padding: 10px; bottom: 300px; text-align: center;">
         ...
         <c:forEach begin="${pm.startPage }" end="${pm.endPage }" var="idx">
            <a href="RecipeController.do?command=allrecipe&contentnum=9&pagenum=${idx}">
               <span>
