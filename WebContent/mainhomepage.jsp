...
<div style="background-color: white; width: 100%; height: 100%; padding: 5%;">
<a href="RecipeController.do?command=start_info" class="a1">레시피정보 DB저장방법</a>
<span class="a1">/</span>
<a href="RecipeController.do?command=start_material" class="a1">레시피재료 DB저장방법</a>
<span class="a1" >/</span>
<a href="RecipeController.do?command=start_process" class="a1">레시피과정 DB저장방법</a>
<span class="a1">/</span>
<a href="RecipeController.do?command=allrecipe" class="a1">모든레시피보기</a>
...
<input type="hidden" name="command" value="myrefrigerator" class="btn_1">
<input type="hidden" name="fakeid" value="fake" class="btn_1">
<input type="submit" value="냉장고에 재료 넣으로 가기" class="btn_1">
</form>
...
<input type="submit" value="추천받기" class="btn_1">
